...
public class TimeOperations {
    ...
    public static String changePSTtoUTC(String pstDate)
    {
        LocalDateTime pstDateTime = LocalDateTime.parse(pstDate, DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
